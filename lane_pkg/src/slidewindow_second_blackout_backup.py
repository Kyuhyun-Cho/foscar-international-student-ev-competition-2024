...
class SlideWindow2:
    ...
    def slidewindow(self, img):
        ...
        win_h1 = 430 #300 
        win_h2 = 720
        win_l_w_l = 170 #225 #130 
        win_l_w_r = 370 #435 #340 # 205
        win_r_w_l = 1280-370#1000 # 1280 - 340
        win_r_w_r = 1280-170#1210 # 1280 - 130 # 550
        ...
        for window in range(0, nwindows):
            if line_flag == 1: 
                ...
                if circle_height - 10 <= win_y_low < circle_height + 10:
                    ...
                    x_location = x_current + int(width * road_width/2)
