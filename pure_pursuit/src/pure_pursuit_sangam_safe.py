...
class PurePursuit:
    def __init__(self):
        ...
        self.is_dynamic_obstacle_done = False
            ...
            if self.is_status == True:
                ...
                if (645 <= self.current_waypoint <= 1299) or (3380 <= self.current_waypoint <= 3700):
                    ...
                    if self.is_dynamic_obstacle is True:
                        ...
                        if (3380 <= self.current_waypoint <= 3700):
                            self.is_dynamic_obstacle_done = True
                ...
                if (1741 <= self.current_waypoint <= 1847):
                    ...
                    self.speed_limit = 20
                elif (3640 <= self.current_waypoint <= 3693):
                    if (self.is_dynamic_obstacle_done is False): # 3662 <= 3693
